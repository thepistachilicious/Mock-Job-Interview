  ...
  return (
    <div className="h-screen w-full bg-[#0b1120] text-white flex flex-col font-sans overflow-hidden relative">
      ...
      <main className="flex-1 w-full relative flex items-center justify-center overflow-hidden">
        ...
        <div
          className={`absolute bottom-6 right-6 w-48 md:w-56 aspect-video bg-black border border-[#334155] rounded-xl shadow-xl z-20 overflow-hidden transition-all duration-300`}
        >
          <video
            ref={videoRef}
            autoPlay
            playsInline
            muted // Quan trọng: Luôn mute video của chính mình để tránh bị vọng tiếng (feedback loop)
          ...
          <div className="absolute bottom-2 left-2 text-[10px] bg-black/60 px-2 py-0.5 rounded text-white font-medium backdrop-blur-sm">
            Bạn {micOn ? "" : "(Muted)"}
          </div>
        </div>
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-3 bg-black/80 backdrop-blur-md border border-[#334155] px-6 py-2.5 rounded-full z-30 shadow-lg">
          <button
            ...
            className={`p-3 rounded-full transition-all duration-300 ${micOn ? "bg-[#1e293b] text-white hover:bg-gray-700" : "bg-red-500 text-black hover:bg-red-600"}`}
          ...
          <button
            ...
            className={`p-3 rounded-full transition-all duration-300 ${camOn ? "bg-[#1e293b] text-white hover:bg-gray-700" : "bg-red-500 text-black hover:bg-red-600"}`}
